...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-rounded)](https://pkg.go.dev/github.com/thesyncim/go-gst)
[![godoc reference](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/thesyncim/go-gst)
[![GoReportCard](https://goreportcard.com/badge/github.com/nanomsg/mangos)](https://goreportcard.com/report/github.com/thesyncim/go-gst)
![](https://github.com/thesyncim/go-gst/workflows/Tests/badge.svg)

See the [godoc.org](https://godoc.org/github.com/thesyncim/go-gst) or [pkg.go.dev](https://pkg.go.dev/github.com/thesyncim/go-gst) references for documentation and examples.
...
For more information, take a look at [this comment](https://github.com/thesyncim/go-gst/issues/3#issuecomment-760648278) with a good run down of the process from compilation to execution.
